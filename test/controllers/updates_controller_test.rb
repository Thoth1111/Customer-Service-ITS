...
class UpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create update" do
    assert_difference("Update.count") do
      post updates_url, params: { update: { updatable_id: @update.updatable_id, updatable_type: @update.updatable_type, update_note: @update.update_note, updated_by: @update.updated_by } }
    end
  ...
  test "should update update" do
    patch update_url(@update), params: { update: { updatable_id: @update.updatable_id, updatable_type: @update.updatable_type, update_note: @update.update_note, updated_by: @update.updated_by } }
