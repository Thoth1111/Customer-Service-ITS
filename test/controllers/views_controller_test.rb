...
class ViewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create view" do
    assert_difference("View.count") do
      post views_url, params: { view: { entity_id: @view.entity_id, entity_type: @view.entity_type, user_id: @view.user_id, view_time: @view.view_time } }
    end
  ...
  test "should update view" do
    patch view_url(@view), params: { view: { entity_id: @view.entity_id, entity_type: @view.entity_type, user_id: @view.user_id, view_time: @view.view_time } }
