class UpdatesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @update.save
        format.html { redirect_to update_url(@update), notice: 'Update was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @update.update(update_params)
        format.html { redirect_to update_url(@update), notice: 'Update was successfully updated.' }
  ...
  def update_params
    params.require(:update).permit(:updated_by, :update_note, :updatable_type, :updatable_id)
  end
end
